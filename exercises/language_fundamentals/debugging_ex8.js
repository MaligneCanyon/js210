...
function updateCart(name, amount) {
  // when updateCart is called as w/ 0 as the explicit amount, the amount is implicitly set to 1
  // amount = amount || 1;
  if (amount === undefined) amount = 1; // only set amount to 1 if its value wasn't spec'd
